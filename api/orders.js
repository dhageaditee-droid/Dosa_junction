        ...
        if (targetSession) {
          ...
          if (!createdOrder) {
            ...
            createdOrder = {
              ...
              payment_method: payload.paymentMethod || targetSession.payment_method || 'Online UPI Payment',
              payment_status: payload.paymentStatus || (payload.paymentMethod === 'Cash on Delivery' ? 'Cash on Delivery' : payload.paymentMethod === 'Pay at Counter' ? 'Pay at Counter' : 'Payment Verified'),
              status: 'Confirmed',
