...
(10, 3, 'Ghee Pudina Masala Dosa', 'Fresh mint (pudina) chutney spread Dosa roasted in pure Ghee', 115.00, '/ghee-pudina-masala-dosa.jpg', TRUE, 'medium', '12 mins', TRUE, FALSE, FALSE, 4.6),
...
-- 3. Dosa / डोसा
(13, 2, 'Plain Dosa', 'Golden crisp plain fermented crepe served with chutneys & sambar', 60.00, '/plain-dosa.jpg', TRUE, 'mild', '10 mins', TRUE, FALSE, TRUE, 4.6),
...
(16, 2, 'Mysore Masala Dosa', 'Red chili paste spread dosa loaded with spiced potato filling', 85.00, '/mysore-masala-dosa.jpg', TRUE, 'spicy', '12 mins', TRUE, TRUE, TRUE, 4.7),
(17, 2, 'Garlic Masala Dosa', 'Garlic spiced spicy potato masala dosa', 85.00, '/garlic-masala-dosa.jpg', TRUE, 'spicy', '12 mins', TRUE, FALSE, FALSE, 4.5),
(18, 2, 'Pudina Masala Dosa', 'Refreshing mint herb paste spread masala dosa', 80.00, '/ghee-pudina-masala-dosa.jpg', TRUE, 'medium', '12 mins', TRUE, FALSE, FALSE, 4.5),
(19, 2, 'Palak Masala Dosa', 'Nutritious green spinach (Palak) paste layered masala dosa', 80.00, '/palak-masala-dosa.jpg', TRUE, 'mild', '12 mins', TRUE, FALSE, FALSE, 4.6),
...
(32, 4, 'Garlic Uttapam', 'Roasted garlic & herb topped Uttapam', 85.00, '/garlic-uttapam.jpg', TRUE, 'medium', '12 mins', TRUE, FALSE, FALSE, 4.5),
